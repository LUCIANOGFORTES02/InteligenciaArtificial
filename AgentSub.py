...
class SubAgent(Agent):
    class SubBehav(CyclicBehaviour):
        async def on_start(self):
            print("Starting SUBTRAÇÃO behaviour . . .")
    ...
    async def setup(self):
        print("Agent SUBTRAÇÃO starting . . .")
        my_behav = self.SubBehav()
...
if __name__ == "__main__":
    dummy = SubAgent("agent6Subtracao@anoxinon.me", "subtracao")
    future = dummy.start()                                            
