...
class AdicaoAgent(Agent):
    class AdicaoBehav(CyclicBehaviour):
        async def on_start(self):
            print("Starting  ADIÇÃO behaviour . . .")
    ...
    async def setup(self):
        print("Agent ADIÇÃO  starting . . .")
        my_behav = self.AdicaoBehav()
...
if __name__ == "__main__":
    dummy = AdicaoAgent("agent4Adicao@anoxinon.me", "adicao")
    future = dummy.start()                                           
